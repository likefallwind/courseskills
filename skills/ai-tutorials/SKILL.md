...
- 每节课产出三个核心文件：
  ...
  - `handsout.md`：本节课的**详细讲义**，对知识点进行充分展开和讲解
...
- 详细讲义 (handsout)：逻辑是否顺畅？概念是否解释清楚？是否为初学者写？是否与 outline 中列出的知识点一一对应？
...
- **与 outline 对齐**：handsout 中讲解的知识点必须与 outline 中列出的一致，不遗漏、不偏题
